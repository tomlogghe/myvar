...
import be.var.myvar.MyvarApp;
import be.var.myvar.domain.Authority;
import be.var.myvar.domain.User;
import be.var.myvar.repository.AuthorityRepository;
...
import be.var.myvar.web.rest.errors.ExceptionTranslator;
import be.var.myvar.web.rest.vm.KeyAndPasswordVM;
...
@SpringBootTest(classes = MyvarApp.class)
