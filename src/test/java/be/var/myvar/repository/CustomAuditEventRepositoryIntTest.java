package be.var.myvar.repository;

import be.var.myvar.MyvarApp;
import be.var.myvar.config.Constants;
import be.var.myvar.config.audit.AuditEventConverter;
import be.var.myvar.domain.PersistentAuditEvent;
...
import static be.var.myvar.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
